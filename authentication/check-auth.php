...
function CheckRight($object, $right) {
    ...
    if($found) {
        ...
        if($object == 'component' && $right == 'view' && substr($user['rights'], 4, 1)) {
            return true;
        }
        if($object == 'component' && $right == 'create' && substr($user['rights'], 5, 1)) {
            return true;
        }
        if($object == 'component' && $right == 'edit' && substr($user['rights'], 6, 1)) {
            return true;
        }
        if($object == 'component' && $right == 'delete' && substr($user['rights'], 7, 1)) {
            return true;
        }
